...
class Parser:
    ...
    def commandType(self):
        ...
        elif self.cur_command[0] == "label":
            return C_LABEL

        elif self.cur_command[0] == "if-goto":
            return C_IF

        elif self.cur_command[0] == "goto":
            return C_GOTO

        elif self.cur_command[0] == "call":
            return C_CALL

        elif self.cur_command[0] == "function":
            return C_FUNC

        elif self.cur_command[0] == "return":
            return C_RET
    ...
    def arg1(self):
        ...
        else:  # C_PUSH, C_POP, C_LABEL, C_FUNC, C_CALL
...
def main():
    ...
    while parser.hasMoreLines():
        ...
        if command_type in [C_PUSH, C_POP, C_FUNC, C_CALL]:
            arg1 = parser.arg1()
            arg2 = parser.arg2()
